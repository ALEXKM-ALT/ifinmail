...
DISPOSABLE_DOMAINS = {
    ...
    "emailfake.com", "mailnator.com", "tempmail.net", "mailmetrash.com",
    "spambox.com", "mailexpire.com", "throwaway.de", "spambob.com",
    "spamcorptastic.com", "nowmymail.com", "mailinator2.com", "sogetthis.com",
    "mailsac.com", "mytemp.email", "mail-temp.com", "emailtemporal.com",
    "mailet.com", "oneoffemail.com", "mailforspam.com", "spamspot.com",
    "sneakemail.com", "jetable.org", "kasmail.com", "mt2009.com",
    "mt2014.com", "mt2015.com", "filzmail.com", "thankyou2010.com",
    "trash2009.com", "mt2008.com", "msgos.com", "podam.pl",
    "wupics.com", "mailexpire.com", "shortmail.net", "spam.la",
    "spamherelots.com", "spamhereplease.com", "spamthisplease.com",
    "thisisnotmyrealemail.com", "trashymail.com", "whatiaas.com",
    "whyspam.me", "youmails.org", "temp-mail.ru", "mintemail.com",
    "tyldd.com", "discard.email", "discardmail.com", "discardmail.de",
    "spamo.com", "spamgoat.com", "spamex.com", "spamlot.com",
    "spamspamspam.com", "thankyou2010.com", "trash2009.com",
    "trashymail.net", "mytempemail.com", "emailtempmail.com",
}

ROLE_PREFIXES = {
    "admin", "administrator", "info", "support", "contact", "sales",
    "noreply", "no-reply", "postmaster", "hostmaster", "webmaster",
    "abuse", "root", "mailer-daemon", "mailerdaemon",
}
...
DOMAIN_TYPOS = {
    ...
    "hotmai.com": "hotmail.com", "hotmal.com": "hotmail.com", "hotmil.com": "hotmail.com",
    "outlok.com": "outlook.com", "outllok.com": "outlook.com", "outloo.com": "outlook.com",
    "protomail.com": "protonmail.com", "protonail.com": "protonmail.com",
...
def verify_email(
    ...
    if syntax_error:
        return VerifyResponse(
            valid=False, syntax_valid=False, syntax_error=syntax_error,
            mx=False, disposable=False, role_based=False, risk="invalid",
            suggestions=[],
        )
