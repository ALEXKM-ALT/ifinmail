...
class DigitalOceanProvider:
    ...
    def _fetch_records(self, domain: str) -> list[dict]:
        ...
        while True:
            data = self._request(
                'GET', f'/domains/{domain}/records', params={'page': page, 'per_page': 100}
            )
        ...
        try:
            ...
            if (
                ...
                return DNSResult(
                    success=False,
                    message=(
                        'Domain not configured in DigitalOcean DNS. '
                        'Add it to DigitalOcean first.'
                    ),
                )
        ...
        for rec in records:
            ...
            try:
                ...
                if key in existing_map:
                    self._request(
                        'PUT', f'/domains/{domain}/records/{existing_map[key]["id"]}', json=payload
                    )
